    ...
    return (
        <div className="px-4 w-full md:w-2/12 mb-4 md:mb-0 accordion">
            <h5 className="text-lg font-semibold mb-2 relative">{title}
                <button onClick={() => setActive(isActive)} className={["absolute block md:hidden right-0 tranform -translate-y-1/2 focus:outline-none transition duration-200 top-1/2 ", isActive ? "rotate - 0" : "rotate - 180"].join(" ")}><svg
                    width="20"
                    height="9"
                    viewBox="0 0 20 9"
                    fill="none"
